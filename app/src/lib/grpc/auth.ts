...
export function loginResponse_LoginFailureCodeFromJSON(object: any): LoginResponse_LoginFailureCode {
  switch (object) {
    case 0:
...
export function loginResponse_LoginFailureCodeToJSON(object: LoginResponse_LoginFailureCode): string {
  switch (object) {
...
function createBaseCredentialsLoginRequest(): CredentialsLoginRequest {
  return { userOrEmail: "", password: "", oneTimePassword: undefined, sessionExpiration: undefined };
}

export const CredentialsLoginRequest: MessageFns<CredentialsLoginRequest> = {
  encode(message: CredentialsLoginRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): CredentialsLoginRequest {
    return {
      ...
      oneTimePassword: isSet(object.oneTimePassword) ? gt.String(object.oneTimePassword) : undefined,
      sessionExpiration: isSet(object.sessionExpiration) ? fromJsonTimestamp(object.sessionExpiration) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<CredentialsLoginRequest>, I>>(base?: I): CredentialsLoginRequest {
    return CredentialsLoginRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CredentialsLoginRequest>, I>>(object: I): CredentialsLoginRequest {
    const message = createBaseCredentialsLoginRequest();
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.response = { $case: "success", value: LoginResponse_LoginSuccess.decode(reader, reader.uint32()) };
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.response = { $case: "failure", value: LoginResponse_LoginFailure.decode(reader, reader.uint32()) };
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.response = { $case: "error", value: LoginResponse_LoginError.decode(reader, reader.uint32()) };
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    switch (object.response?.$case) {
      case "success": {
        if (object.response?.value !== undefined && object.response?.value !== null) {
          message.response = { $case: "success", value: LoginResponse_LoginSuccess.fromPartial(object.response.value) };
        }
        break;
      }
      case "failure": {
        if (object.response?.value !== undefined && object.response?.value !== null) {
          message.response = { $case: "failure", value: LoginResponse_LoginFailure.fromPartial(object.response.value) };
        }
        break;
      }
      case "error": {
        if (object.response?.value !== undefined && object.response?.value !== null) {
          message.response = { $case: "error", value: LoginResponse_LoginError.fromPartial(object.response.value) };
        }
        break;
      }
    }
...
export const LoginResponse_LoginSuccess: MessageFns<LoginResponse_LoginSuccess> = {
  encode(message: LoginResponse_LoginSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
  ...
  create<I extends Exact<DeepPartial<LoginResponse_LoginSuccess>, I>>(base?: I): LoginResponse_LoginSuccess {
    return LoginResponse_LoginSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LoginResponse_LoginSuccess>, I>>(object: I): LoginResponse_LoginSuccess {
    const message = createBaseLoginResponse_LoginSuccess();
...
export const LoginResponse_LoginFailure: MessageFns<LoginResponse_LoginFailure> = {
  encode(message: LoginResponse_LoginFailure, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
  ...
  create<I extends Exact<DeepPartial<LoginResponse_LoginFailure>, I>>(base?: I): LoginResponse_LoginFailure {
    return LoginResponse_LoginFailure.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LoginResponse_LoginFailure>, I>>(object: I): LoginResponse_LoginFailure {
    const message = createBaseLoginResponse_LoginFailure();
...
export const LoginResponse_LoginError: MessageFns<LoginResponse_LoginError> = {
  encode(message: LoginResponse_LoginError, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
      writer.uint32(8).int32(message.code);
    }
    if (message.message !== "") {
  ...
  create<I extends Exact<DeepPartial<LoginResponse_LoginError>, I>>(base?: I): LoginResponse_LoginError {
    return LoginResponse_LoginError.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LoginResponse_LoginError>, I>>(object: I): LoginResponse_LoginError {
    const message = createBaseLoginResponse_LoginError();
    message.code = object.code ?? 0;
